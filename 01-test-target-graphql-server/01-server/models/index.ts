...
const configPath = path.join(process.cwd(), '01-test-target-graphql-server/01-server/config.json');
const config = JSON.parse(fs.readFileSync(configPath).toString())[env];
export const db: any = {};
